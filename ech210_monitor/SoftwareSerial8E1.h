...
#ifndef SoftwareSerial8E1_h
#define SoftwareSerial8E1_h
...
public:
  ...
  SoftwareSerial8E1(int receivePin, int transmitPin, bool inverse_logic = false, unsigned int buffSize = 64, uint8_t parity = EVEN);
  virtual ~SoftwareSerial8E1();
